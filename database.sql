...
CREATE VIEW public.max_salaries AS
 SELECT employees.department_id,
    max(employees.salary) AS max_salary
   FROM public.employees
  GROUP BY employees.department_id;
...
CREATE VIEW public.max_salary AS
 SELECT employees.department_id,
...
--
-- Name: number_employees; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.number_employees (
...
COPY public.number_employees (department_id, no_employees) FROM stdin;
70	1
20	2
40	1
30	6
...
COPY public.persons (p_id, lastname, firstname, address, city) FROM stdin;
...
--
-- Name: p1index; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX p1index ON public.persons USING btree (lastname, firstname);


--
-- Name: pindex; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pindex ON public.persons USING btree (lastname, firstname);
